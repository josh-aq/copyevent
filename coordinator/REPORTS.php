        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><button onclick="location.href='PACKAGES.php'">PACKAGES</button></li>                    <li><button onclick="location.href='../globalaccess/newsfeed.php'">NEWSFEED</button></li>                    <li><button onclick="location.href='MESSAGES.php'">MESSAGES</button></li>
